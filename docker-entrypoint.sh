...
mediawiki_install() {
  ...
  ln -s $mwpath $apachepath/mediawiki
	...
	then
	  ...
	  color_msg $blue "you can now install MediaWiki with the url http://docker/mediawiki"
	else
	  ...
	  color_msg $blue "you can now login to MediaWiki with the url http://docker/mediawiki"
